...
function fetchRoadDetail(raw: any): JobRoadDetail | null {
  ...
  return {
    ...
    customs_paperwork_company: nullableString(raw.customs_paperwork_company),
    customs_paperwork_address_line_1: nullableString(raw.customs_paperwork_address_line_1),
    customs_paperwork_city: nullableString(raw.customs_paperwork_city),
    customs_paperwork_postcode: nullableString(raw.customs_paperwork_postcode),
    customs_paperwork_country: nullableString(raw.customs_paperwork_country),
    customs_paperwork_contact_name: nullableString(raw.customs_paperwork_contact_name),
    customs_paperwork_phone: nullableString(raw.customs_paperwork_phone),
    customs_paperwork_email: nullableString(raw.customs_paperwork_email),
    customs_paperwork_opening_hours: nullableString(raw.customs_paperwork_opening_hours),
    customs_paperwork_appointment_required: nullableBoolean(
      raw.customs_paperwork_appointment_required,
    ),
    customs_paperwork_appointment_ref: nullableString(raw.customs_paperwork_appointment_ref),
    customs_paperwork_documents: nullableString(raw.customs_paperwork_documents),
    customs_paperwork_notes: nullableString(raw.customs_paperwork_notes),
    customs_departure_office: nullableString(raw.customs_departure_office),
    customs_departure_office_ref: nullableString(raw.customs_departure_office_ref),
    customs_departure_status: nullableString(raw.customs_departure_status),
    customs_departure_estimated_at: nullableString(raw.customs_departure_estimated_at),
    customs_departure_notes: nullableString(raw.customs_departure_notes),
    customs_delivery_clearance_company: nullableString(raw.customs_delivery_clearance_company),
    customs_delivery_clearance_address_line_1: nullableString(
      raw.customs_delivery_clearance_address_line_1,
    ),
    customs_delivery_clearance_city: nullableString(raw.customs_delivery_clearance_city),
    customs_delivery_clearance_postcode: nullableString(raw.customs_delivery_clearance_postcode),
    customs_delivery_clearance_country: nullableString(raw.customs_delivery_clearance_country),
    customs_delivery_clearance_office_code: nullableString(
      raw.customs_delivery_clearance_office_code,
    ),
    customs_delivery_clearance_contact_name: nullableString(
      raw.customs_delivery_clearance_contact_name,
    ),
    customs_delivery_clearance_phone: nullableString(raw.customs_delivery_clearance_phone),
    customs_delivery_clearance_opening_hours: nullableString(
      raw.customs_delivery_clearance_opening_hours,
    ),
    customs_delivery_clearance_appointment_ref: nullableString(
      raw.customs_delivery_clearance_appointment_ref,
    ),
    customs_delivery_clearance_status: nullableString(raw.customs_delivery_clearance_status),
    customs_delivery_clearance_notes: nullableString(raw.customs_delivery_clearance_notes),
...
function fetchCharge(raw: any): JobCharge {
  return {
    ...
    quantity: nullableNumber(raw.quantity),
    unit_amount: nullableNumber(raw.unit_amount),
    exchange_rate: nullableNumber(raw.exchange_rate),
